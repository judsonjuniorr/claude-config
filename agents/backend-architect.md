...
description: Senior backend architect. Use when designing APIs, database schemas, event-driven systems, microservices, or evaluating technology trade-offs for backend systems.
