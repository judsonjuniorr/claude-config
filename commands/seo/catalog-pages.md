---
description: Programmatic long-tail catalog pages — generate or validate unique per-item title/meta/schema with cannibalization + uniqueness checks, gated on human approval.
