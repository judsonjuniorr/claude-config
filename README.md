...
| Skill   | [`github-ops`](./skills/github-ops/README.md)                | Token-efficient GitHub/GitLab ops via `gh`/`glab`. Emoji Conventional Commits, pre-commit checks, split detection, PR/issue/CI management. |
